...
{
 function sum_of_even_number (n:number):number{
        let sum = 0;
...
{
    let num:number []=[1,4,5,9,23,12,23.5,18,66,56,19]
...
let  num:number[]= [12,23,14,53,19,43,56,26,29,31,20]
for(let number of num){
    if(number%2!=0){
        console.log(number)
    }
...
{
function failingMarks(grades: number[]): number[] {
  ...
  const gradesList: number[] = [75, 42, 65, 30, 75, 40, 35, 100]; 
...
const numberArray2: number[] = [15,90,45,64,143,130,521]; 
